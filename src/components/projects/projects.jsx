    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-0 left-0 right-0 z-10 p-4 translate-y-1 transition-transform duration-300 group-hover:translate-y-0">
                ...
                <div className="flex gap-1 md:gap-4 opacity-100 md:opacity-0 transition-opacity duration-300 md:group-hover:opacity-100 md:group-hover:mt-6 z-20">
                    {githubUrl && (
                        <a
                            href={githubUrl}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="relative z-10 flex items-center gap-1 md:gap-2 rounded-full border border-main bg-card px-1.5 py-0.5 md:px-4 md:py-2 text-[9px] mt-2 md:text-sm text-main transition-all duration-200 hover:opacity-80"
                        >
                    ...
                    {demoUrl && demoUrl !== "#" && (
                        <PreviewLinkCard href={demoUrl}
                            ...
                            <PreviewLinkCardTrigger
                                target="_blank"
                                className="underline relative flex items-center gap-1 md:gap-2 rounded-full bg-[#2563eb] dark:bg-[#C8FF00] px-1.5 py-0.5 md:px-4 md:py-2 sm:text-xs text-[9px] md:text-sm font-semibold text-white dark:text-black transition-all duration-200 hover:bg-[#2563eb] dark:hover:bg-[#D4FF33] hover:shadow-[0_0_20px_rgba(37, 99, 235)] dark:hover:shadow-[0_0_20px_rgba(200,255,0,0.4)]"
                            >
                                {t("projects.seeDemo")}
                            </PreviewLinkCardTrigger>
